...
let package = Package(
    ...
    products: [
        ...
        .library(name: "TreeSitterJsonnet", targets: ["TreeSitterJsonnet"]),
        .library(name: "TreeSitterJsonnetQueries", targets: ["TreeSitterJsonnetQueries"]),
        .library(name: "TreeSitterJsonnetRunestone", targets: ["TreeSitterJsonnetRunestone"]),
        ...
        .library(
            name: "TreeSitterMarkdownInlineQueries", targets: ["TreeSitterMarkdownInlineQueries"]),
        .library(
            name: "TreeSitterMarkdownInlineRunestone",
            targets: ["TreeSitterMarkdownInlineRunestone"]),
    ...
    dependencies: [
        .package(url: "https://github.com/imfuxiao/Runestone", from: "0.4.1")
    ],
    targets: [
        ...
        .target(
            name: "TreeSitterAstroRunestone",
            dependencies: ["Runestone", "TreeSitterAstro", "TreeSitterAstroQueries"]),
        ...
        .target(
            name: "TreeSitterCommentRunestone",
            dependencies: ["Runestone", "TreeSitterComment", "TreeSitterCommentQueries"]),
        ...
        .target(
            name: "TreeSitterCSharpRunestone",
            dependencies: ["Runestone", "TreeSitterCSharp", "TreeSitterCSharpQueries"]),
        ...
        .target(
            ...
            dependencies: [
                "Runestone", "TreeSitterCPP", "TreeSitterCPPQueries", "TreeSitterCQueries",
            ]),
        .target(name: "TreeSitterCSS", cSettings: [.headerSearchPath("src")]),
        .target(name: "TreeSitterCSSQueries", resources: [.copy("highlights.scm")]),
        .target(
            name: "TreeSitterCSSRunestone",
            dependencies: ["Runestone", "TreeSitterCSS", "TreeSitterCSSQueries"]),
        .target(name: "TreeSitterElixir", cSettings: [.headerSearchPath("src")]),
        .target(
            name: "TreeSitterElixirQueries",
            resources: [.copy("highlights.scm"), .copy("tags.scm")]),
        .target(
            name: "TreeSitterElixirRunestone",
            dependencies: ["Runestone", "TreeSitterElixir", "TreeSitterElixirQueries"]),
        .target(name: "TreeSitterElm", cSettings: [.headerSearchPath("src")]),
        .target(name: "TreeSitterElmQueries", resources: [.copy("highlights.scm")]),
        .target(
            name: "TreeSitterElmRunestone",
            dependencies: ["Runestone", "TreeSitterElm", "TreeSitterElmQueries"]),
        ...
        .target(
            name: "TreeSitterHaskellRunestone",
            dependencies: ["Runestone", "TreeSitterHaskell", "TreeSitterHaskellQueries"]),
        .target(name: "TreeSitterHTML", cSettings: [.headerSearchPath("src")]),
        .target(
            name: "TreeSitterHTMLQueries",
            resources: [.copy("highlights.scm"), .copy("injections.scm")]),
        .target(
            name: "TreeSitterHTMLRunestone",
            dependencies: ["Runestone", "TreeSitterHTML", "TreeSitterHTMLQueries"]),
        ...
        .target(
            name: "TreeSitterJSDocRunestone",
            dependencies: ["Runestone", "TreeSitterJSDoc", "TreeSitterJSDocQueries"]),
        .target(name: "TreeSitterJSON", cSettings: [.headerSearchPath("src")]),
        .target(name: "TreeSitterJSONQueries", resources: [.copy("highlights.scm")]),
        .target(
            name: "TreeSitterJSONRunestone",
            dependencies: ["Runestone", "TreeSitterJSON", "TreeSitterJSONQueries"]),
        .target(name: "TreeSitterJSON5", cSettings: [.headerSearchPath("src")]),
        .target(
            name: "TreeSitterJSON5Queries",
            resources: [.copy("highlights.scm"), .copy("injections.scm")]),
        .target(
            name: "TreeSitterJSON5Runestone",
            dependencies: ["Runestone", "TreeSitterJSON5", "TreeSitterJSON5Queries"]),
        .target(name: "TreeSitterJsonnet", cSettings: [.headerSearchPath("src")]),
        .target(name: "TreeSitterJsonnetQueries", resources: [.copy("highlights.scm")]),
        .target(
            name: "TreeSitterJsonnetRunestone",
            dependencies: ["Runestone", "TreeSitterJsonnet", "TreeSitterJsonnetQueries"]),
        .target(name: "TreeSitterJulia", cSettings: [.headerSearchPath("src")]),
        .target(
            name: "TreeSitterJuliaQueries",
            resources: [.copy("highlights.scm"), .copy("injections.scm")]),
        .target(
            name: "TreeSitterJuliaRunestone",
            dependencies: ["Runestone", "TreeSitterJulia", "TreeSitterJuliaQueries"]),
        .target(name: "TreeSitterLaTeX", cSettings: [.headerSearchPath("src")]),
        .target(
            name: "TreeSitterLaTeXQueries",
            resources: [.copy("highlights.scm"), .copy("injections.scm")]),
        .target(
            name: "TreeSitterLaTeXRunestone",
            dependencies: ["Runestone", "TreeSitterLaTeX", "TreeSitterLaTeXQueries"]),
        .target(name: "TreeSitterLua", cSettings: [.headerSearchPath("src")]),
        .target(
            name: "TreeSitterLuaQueries",
            resources: [.copy("highlights.scm"), .copy("injections.scm")]),
        .target(
            name: "TreeSitterLuaRunestone",
            dependencies: ["Runestone", "TreeSitterLua", "TreeSitterLuaQueries"]),
        .target(name: "TreeSitterMarkdown", cSettings: [.headerSearchPath("src")]),
        .target(
            name: "TreeSitterMarkdownQueries",
            resources: [.copy("highlights.scm"), .copy("injections.scm")]),
        .target(
            name: "TreeSitterMarkdownRunestone",
            dependencies: ["Runestone", "TreeSitterMarkdown", "TreeSitterMarkdownQueries"]),
        ...
        .target(
            name: "TreeSitterMarkdownInlineRunestone",
            dependencies: [
                "Runestone", "TreeSitterMarkdownInline", "TreeSitterMarkdownInlineQueries",
            ]),
        ...
        .target(
            name: "TreeSitterOCamlRunestone",
            dependencies: ["Runestone", "TreeSitterOCaml", "TreeSitterOCamlQueries"]),
        .target(name: "TreeSitterPerl", cSettings: [.headerSearchPath("src")]),
        .target(name: "TreeSitterPerlQueries", resources: [.copy("highlights.scm")]),
        .target(
            name: "TreeSitterPerlRunestone",
            dependencies: ["Runestone", "TreeSitterPerl", "TreeSitterPerlQueries"]),
        ...
        .target(
            name: "TreeSitterPHPRunestone",
            dependencies: ["Runestone", "TreeSitterPHP", "TreeSitterPHPQueries"]),
        ...
        .target(
            name: "TreeSitterRRunestone",
            dependencies: ["Runestone", "TreeSitterR", "TreeSitterRQueries"]),
        ...
        .target(
            name: "TreeSitterRegexRunestone",
            dependencies: ["Runestone", "TreeSitterRegex", "TreeSitterRegexQueries"]),
        .target(name: "TreeSitterRuby", cSettings: [.headerSearchPath("src")]),
        .target(
            name: "TreeSitterRubyQueries",
            resources: [.copy("highlights.scm"), .copy("locals.scm"), .copy("tags.scm")]),
        .target(
            name: "TreeSitterRubyRunestone",
            dependencies: ["Runestone", "TreeSitterRuby", "TreeSitterRubyQueries"]),
        ...
        .target(
            name: "TreeSitterSCSSRunestone",
            dependencies: ["Runestone", "TreeSitterSCSS", "TreeSitterSCSSQueries"]),
        ...
        .target(
            ...
            resources: [.copy("highlights.scm"), .copy("injections.scm")]),
        .target(
            name: "TreeSitterSvelteRunestone",
            dependencies: ["Runestone", "TreeSitterSvelte", "TreeSitterSvelteQueries"]),
        ...
        .target(
            ...
            resources: [.copy("highlights.scm"), .copy("locals.scm"), .copy("tags.scm")]),
        .target(
            name: "TreeSitterTSXRunestone",
            dependencies: [
                "Runestone", "TreeSitterTSX", "TreeSitterTSXQueries", "TreeSitterJavaScriptQueries",
            ]),
